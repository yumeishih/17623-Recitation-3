...
public class TicTacToe {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    System.out.printf(
        "How to play - wait for your turn and when it comes write the number of the field that you want to draw in (from 1 to 9)\n");
    ...
    while (true) {
      ...
      System.out.printf(
          "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
      if (null != Winners(a1, a2, a3, a4, a5, a6, a7, a8, a9))
        switch (Winners(a1, a2, a3, a4, a5, a6, a7, a8, a9)) {
          case "NONE":
  ...
  public static void PrintBoard(String f1, String f2, String f3, String f4, String f5, String f6, String f7, String f8,
      String f9) {
  ...
  public static String Winners(String f1, String f2, String f3, String f4, String f5, String f6, String f7, String f8,
      String f9) {
    if (f1 == f2 && f2 == f3 && f3 == "O") {
      return "O";
